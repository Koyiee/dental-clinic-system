      ...
      <div class="header">
        ...
        <div class="text">
            ...
            <div class="breadcrumbs">
              ...
              <a class="current" href="/hrannouncements"><p>  Announcements</p></a>
            </div>
        </div>
      </div>
      </div>
      ...
      <div class="announcements-container">
            ...
            >
              <div class="announcement-header">
                ...
                <div class="announcement-actions">
                  <button class="action-button" @click.stop="openEditPost(announcement)">
                    <i class='bx bx-edit'></i>
                  </button>
                  <button class="action-button" @click.stop="openDeleteConfirm(announcement)">
        ...
        <div v-show="activeTab === 'unpublished'" class="tab-content">
          ...
          <div v-else class="empty-state">
            ...
            <p>There are currently no unpublished announcements.</p>
          </div>
        </div>
        ...
        <div v-show="activeTab === 'past'" class="tab-content">
          ...
          <div v-else class="empty-state">
            ...
            <p>There are currently no past announcements.</p>
          </div>
        </div>
        ...
        <div v-show="activeTab === 'deleted'" class="tab-content">
          ...
          <div v-else class="empty-state">
            ...
            <p>There are currently no deleted announcements.</p>
          </div>
        </div>
      </div>
      ...
      <div v-if="showModal" class="modal-overlay">
        <div class="modal-content" @click.stop>
          <div class="modal-header">
            ...
            <button class="close-button" @click="confirmCancelCreate">
              <i class='bx bx-x'></i>
            </button>
          </div>
          ...
          <form class="modal-body" @submit.prevent="confirmPublish">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="cancel-btn" @click="confirmCancelCreate">
      ...
      <div v-if="showEditModal" class="modal-overlay">
        <div class="modal-content" @click.stop>
          <div class="modal-header">
            ...
            <button class="close-button" @click="confirmCancelEdit">
              <i class='bx bx-x'></i>
            </button>
          </div>
          
          <form class="modal-body" @submit.prevent="confirmUpdate">
            <div class="form-group">
            ...
            <div class="modal-footer">
              <button type="button" class="cancel-btn" @click="confirmCancelEdit">
                <i class='bx bx-x'></i> Cancel
              </button>
              <button type="submit" class="publish-btn">
...
export default {
  ...
  computed: {
    ...
    filteredAnnouncements() {
      switch (this.activeTab) {
        case 'published':
          return this.displayedPublished;
        case 'unpublished':
          return this.displayedUnpublished;
        case 'past':
          return this.displayedPast;
        case 'deleted':
          return this.displayedDeleted;
        default:
          return [];
      }
    },
  ...
  methods: {
    ...
    confirmCancelCreate() {
      if (this.title || this.description || this.attachment || this.targetUser || this.priority || this.startDate || this.endDate) {
        Swal.fire({
    ...
    openEditPost(announcement) {
      this.editForm = {
        ...
        attachment: null,
        createdBy: announcement.createdBy || "HR Admin"
      };
    ...
    openDeleteConfirm(announcement) {
      ...
      Swal.fire({
        ...
        text: `Are you sure you want to delete "${this.announcementToDelete.title}"? This action cannot be undone.`,
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#06693A',
        cancelButtonColor: '#d33',
    ...
    async createPost() {
      ...
      formData.append("AnnouncementTitle", this.title.replace(/[^\x00-\x7F]/g, ''));
      formData.append("AnnouncementDescription", this.description.replace(/[^\x00-\x7F]/g, ''));
      formData.append("TargetUser", this.targetUser);
      formData.append("Priority", this.priority);
      formData.append("StartDate", this.startDate);
      formData.append("EndDate", this.endDate);
      formData.append("CreatedBy", "HR Admin");
      ...
      try {
        const response = await axios.post("/announcements/store/hr", formData, {
          headers: { 
    ...
    async deleteAnnouncement() {
      ...
      const deletedAnnouncement = { ...this.announcementToDelete };

      try {
        const response = await axios.delete(`/announcements/${announcementId}`);

        deletedAnnouncement.deletedAt = new Date().toISOString();
        deletedAnnouncement.status = 'deleted';
...
/* Delete button and status styles */
.delete-btn {
  background-color: #ff4d4f;
  color: white;
  border: none;
