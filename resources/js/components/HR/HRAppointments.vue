      ...
      <div class="header">
        ...
        <div class="text">
          ...
          <div class="breadcrumbs">
            ...
            <a class="current" href="/hrappointments"><p>Appointments</p></a>
          </div>
        </div>
      </div>
      <hr color="#06693a">
  ...
  methods: {
    ...
    async confirmAppointment(appointmentId) {
      ...
      const result = await Swal.fire({
        ...
        text: `Are you sure you want to confirm ${patientName}'s appointment?`,
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#06693a',
        cancelButtonColor: '#d33',
      ...
      if (result.isConfirmed) {
        try {
          ...
          await Swal.fire({
            ...
            text: `The appointment for ${patientName} has been confirmed.`,
            timer: 2000,
            showConfirmButton: false,
          });
          if (this.showDetailModal) {
