  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <div v-if="currentFormStep === 'consent'" class="dental-consent-container">
        ...
        <!-- Check All Consent Checkbox -->
        <div class="dental-consent-signature-line">
            <div class="dental-consent-checkbox-container check-all-container">
                <input type="checkbox" id="check_all_consent" name="check_all_consent" v-model="checkAllConsent" @change="toggleAllConsent" />
                <label for="check_all_consent">I agree to all consent items below</label>
            </div>
        </div>
      ...
      <div v-if="currentFormStep === 'questionnaire'" class="patient-questionnaire-container">
        ...
        <div class="questionnaire-form">
          ...
          <div class="question-row">
            ...
            <div class="question-input">
              <input type="text" v-model="questionnaire.bloodType" 
                    class="text-input">
            </div>
          </div>
...
/* Specifically target informed consent checkboxes */
...
.dental-consent-checkbox-container input[type="checkbox"]:checked {
  background-color: #06693a;
}

.dental-consent-checkbox-container input[type="checkbox"]:checked::after {
  content: '✓';
  position: absolute;
  color: white;
  font-size: 16px;
...
#patient_authorize_treatment {
  width: 75px;
  height: 19px;
}

#patient_consent_to_treatment {
  width: 22px;
  height: 20px;
}

#patient_acknowledge_inexact_science {
  width: 20px;
  height: 20px;
}
...
/* Ensure text alignment with larger checkboxes */
.radio-option span,
...
/* Adjust spacing for allergy and condition options */
.allergy-option, .condition-option {
  margin-bottom: 10px;
}
...
.fc-col-header-cell {
  width: 160px !important; /* Adjust column width */
}
...
/* New Styles for Unavailable Slots */
.time-button.unavailable {
  background-color: #d0d0d0; /* Darker gray to indicate unavailability */
  border-color: #bbb;
...
.time-button.unavailable i {
  color: #555; /* Mute the icon color */
}

.time-button.unavailable:hover {
  background-color: #d0d0d0; /* Prevent hover effect */
  transform: none; /* Disable hover animation */
}
...
.unavailable-label {
  font-size: 0.85em; /* Slightly smaller font for the label */
  color: #ff5555; /* Red color to indicate "Booked" */
  font-weight: 500;
}
...
/* Style for the check all consent container */
.check-all-container {
  background-color: #f0f7f4;
  padding: 10px;
  border-radius: 5px;
  border-left: 5px solid #06693a;
  margin-bottom: 15px;
}
...
.fc .fc-daygrid-day.fc-day-today {
  background-color: rgba(6, 105, 58, 0.15) !important; /* Light green */
  pointer-events: auto !important; /* Ensure today's date is clickable */
