<template>
  ...
  <section class="home-section">
      ...
      <div class="header">
        ...
        <div class="text">
            ...
            <div class="breadcrumbs">
              ...
              <a class="current" href="/dentistsettings"><p>  Settings</p></a>
            </div>
        </div>
      </div>
      <hr color="#06693a">
   ...
   <section class="settings-section">
    ...
    <!-- Success Modal -->
    <div class="modal-backdrop" v-if="showSuccessModal" @click="showSuccessModal = false">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <p>Your password has been updated successfully. Please log out and log in with your new password.</p>
        </div>
        <div class="modal-footer">
          <button class="modal-button" @click="showSuccessModal = false">Close</button>
        </div>
      </div>
    </div>
    <br>
  ...
  methods: {
    ...
    validateNewPassword() {
      ...
      if (!this.hasUpperCase || !this.hasLowerCase || !this.hasNumber || !this.hasSpecialChar) {
        this.errors.new_password = 'Password must include all required elements.';
        this.isNewPasswordValid = false;
        return;
      }
